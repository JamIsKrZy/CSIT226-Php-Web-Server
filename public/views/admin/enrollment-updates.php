...
<body>
    ...
    <main class="main-container">
        ...
        <div class="content-wrapper">
            <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-end; position: sticky; top: 70px; background: var(--bg-main); z-index: 80; padding: 10px 0 20px 0;">
                <div>
                    <h2>Enrollment Updates</h2>
                    <p>Manage student-facing enrollment announcements and advisories.</p>
                </div>
            ...
            <div class="filters-container card" style="max-width: 900px; margin-top: 24px; margin-bottom: 24px;">
            ...
            <div class="updates-feed-container" style="max-width: 900px;">
                <div class="card">
